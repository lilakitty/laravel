                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="page-header">
                                    ...
                                    <button type="button" class="btn btn-primary mr-1 mb-2"><i class="la la-plus-square-o"></i>Publicar proyecto</button>
                                </div>
                            </div>
                            <!-- End Page Header -->
                            <div class="row">
                                                ...
                                                <table id="sorting-table" class="table mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>$7</td>
                                                            <td class="td-actions">
                                                                <a href="#"><i class="la la-edit edit" title="Enviar propuesta"></i></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
