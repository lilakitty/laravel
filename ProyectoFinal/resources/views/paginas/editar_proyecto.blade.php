                ...
                <div class="widget-body">
                    <form class="needs-validation" novalidate>
                        <div class="form-group row d-flex align-items-center mb-5">
                            ...
                            <div class="col-lg-5">
                                <input type="text" class="form-control" placeholder="Datos del proyecto">
                            </div>
                        </div>
                        <div class="form-group row d-flex align-items-center mb-5">
                        ...
                        <div class="form-group row d-flex align-items-center mb-5">
                                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Presupuesto</label>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" placeholder="Presupuesto">
                                </div>
                        </div>
                        <div class="form-group row d-flex align-items-center mb-5">
                                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Tamaño del proyecto</label>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" placeholder="Tamaño del proyecto">
                                </div>
                        </div>
                        <div class="form-group row d-flex align-items-center mb-5">
                                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Categoría del proyecto</label>
                                <div class="col-lg-5">
                                    <div class="select">
                                        <select name="account" class="custom-select form-control" required>
                                            
                                            <option value="1">Desarrollo web</option>
                                            <option value="2">Aplicaciones móvils</option>
                                            <option value="3">Sistemas para escritorio</option>
                        ...
                        <div class="text-right">
                            <button class="btn btn-gradient-01" type="submit">Subir proyecto</button>
