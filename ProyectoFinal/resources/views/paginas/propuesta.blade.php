                ...
                <div class="widget-body">
                    <form class="needs-validation" novalidate>
                            <div class="form-group row d-flex align-items-center mb-5">
                                    <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Propuesta</label>
                                    <div class="col-lg-5">
                                        <textarea class="form-control" placeholder="Descripción de la propuesta ..." required></textarea>
                        ...
                        <div class="text-right">
                            <button class="btn btn-gradient-01" type="submit">Enviar propuesta</button>
